...
def run_program(args):
    ...
    def log_message(text, *args):
        if startup_debug:# TODO 如果开启debug模式，打印一些关于运行环境的信息
            text = text % args
    ...
    log_message('sys.prefix = %r', os.path.normpath(sys.prefix)) # TODO 获取项目可执行文件路径
    ...
    log_message('program_exe_path = %r', program_exe_path) # TODO 获取服务启动程序地址
